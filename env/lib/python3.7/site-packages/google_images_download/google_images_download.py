...
class googleimagesdownload:
    ...
    # Download Images
    def download_image(self,search_term,image_url,image_format,main_directory,dir_name,count,print_urls,socket_timeout,prefix,print_size,no_numbering,no_download):
        if print_urls or no_download:
            print("Image URL: " + image_url)
        if no_download:
        ...
        try:
            ...
            try:
                ...
                image_name = str(image_url[(image_url.rfind('/')) + 1:]) # change thi
    ...
    # Getting all links with the help of '_images_get_next_image'
    def _get_all_items(self,search_term, page,main_directory,dir_name,limit,arguments):
        items = []
        abs_path = []
        errorCount = 0
        i = 0
        ...
        while count < limit+1:
            ...
            if object == "no_links":
                ...
                #download the images
                download_status,download_message,return_image_name,absolute_path = self.download_image(search_term, object['image_link'],object['image_format'],main_directory,dir_name,count,arguments['print_urls'],arguments['socket_timeout'],arguments['prefix'],arguments['print_size'],arguments['no_numbering'],arguments['no_download'])
        ...
        for pky in prefix_keywords:
            for sky in suffix_keywords:     # 1.for every suffix keywords
                ...
                while i < len(search_keyword):      # 2.for every main keyword
                    ...
                    items,errorCount,abs_path = self._get_all_items(search_term, raw_html,main_directory,dir_name,limit,arguments)    #get all image items and download images
